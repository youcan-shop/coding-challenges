...
2. When you're ready to start the test, make sure you init a Google document and share the link by email to **tech-challenge@youcan.shop** with the object **Technical writer application by FirstName LastName**, it'll be considered as the time your started working on the challenge.
3. Once you're done with the test, reply again to your last email to notify us you're done with it.
